...
int main() {
    ...
    // Display your name
    cout << "===== Shaiju Maharjan =====" << endl;
    cout << "3D Wireframe Cube Program" << endl;
    ...
    // Draw edges with simple isometric projection
    for(int i=0; i<12; i++){
    ...
    outtextxy(10, 10, (char*)"Shaiju Maharjan");
    outtextxy(10, 30, (char*)"3D Wireframe Cube Program");
